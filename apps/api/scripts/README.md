...
| `smoke_pipeline.sh` | Boot the API, POST the Rotterdam demo PDFs, poll until done, assert `demurrage_due_usd == 84375`. | **YES** — gated; do not run without explicit user authorisation |
