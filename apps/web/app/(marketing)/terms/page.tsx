...
export const metadata: Metadata = {
  title: "Terms · Papership.Ai",
  description:
    "The contract between you and Papership.Ai for use of the demurrage claims service.",
};

const SECTIONS: { eyebrow: string; body: string }[] = [
  {
    eyebrow: "Agreement",
    body: "By creating an account or using the Papership.Ai service you agree to these terms. If you are using the service on behalf of an organisation you represent that you have authority to bind that organisation. If you do not agree, do not use the service.",
  },
  {
    eyebrow: "The service",
    body: "Papership.Ai provides AI-assisted workflows for maritime claims. Outputs from the service, including draft claim letters and laytime calculations, are produced by AI models and deterministic code. They are tools for licensed professionals and are not a substitute for legal or maritime advice. You remain responsible for any claim you file.",
  },
  {
    eyebrow: "Your account",
    body: "You must keep your credentials confidential and notify us immediately at security@papership.ai if you suspect they have been compromised. You are responsible for activity that occurs under your account.",
  },
  {
    eyebrow: "Your content",
    body: "You retain all rights in the voyage documents and other content you upload. You grant Papership.Ai a limited licence to process that content for the sole purpose of providing the service. We do not train shared AI models on your content.",
  },
  {
  ...
  },
  {
    ...
    body: "The service is provided on an as-is basis. To the maximum extent permitted by law, Papership.Ai's aggregate liability for any claim arising from these terms is limited to the fees paid to us in the twelve months preceding the claim. Nothing in these terms limits liability for gross negligence, wilful misconduct, or any liability that cannot be excluded by law.",
  },
  {
    ...
    <main className="pt-24">
      <Section>
        ...
        <h1 className="text-display mt-6 max-w-3xl text-primary">
          The contract between you and Papership.Ai.
        </h1>
