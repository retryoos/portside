...
// Upload entry for a live voyage. Collects the three PDFs and hands them up
// to the dashboard, which calls createVoyage + pollVoyage. Filed from the
// owner's side; the demo voyage is reached via the seeded fixture, not from
// here.
  ...
  return (
    <section className="rounded-card border border-border bg-surface p-7 md:p-8">
      ...
      <p className="mt-3 max-w-2xl text-body text-secondary">
        Upload the three voyage documents (PDF) and the pipeline drafts the
        claim packet end to end.
      </p>
