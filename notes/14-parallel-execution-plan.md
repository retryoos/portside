...
| 1k| `data/scenarios`                  | dkall (own Cursor C1) | own — runs autonomously   | `synthetic-data/generate.py`, `synthetic-data/scenarios/athens-weather-dispute/*`                       | 3 PDFs + `expected.json` exist; numbers reconcile to USD 38,400 |
