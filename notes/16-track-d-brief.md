...
| 2 | `Track D: cross-cutting prompt prefix + load_prompt() helper` | `portside_api/prompts/__init__.py` (`load_prompt(name)`, lru-cached) + `portside_api/prompts/cross_cutting.md` (verbatim from `notes/11-prompts.md`, anchored to EUR 84,375). 6 tests including a vocab-marker guard. |
